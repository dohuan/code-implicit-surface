function Pat_list = patient_list_speed(pat_name, mode)
...
Pat_list(1).band_x = 2.5; % 1.05
Pat_list(1).band_y = 2.5; % 1.05
Pat_list(1).band_z = 2.5; % 1.05
Pat_list(1).band_f = 1.0; % 0.95

Pat_list(2).name = 'II';
Pat_list(2).ID = 'I';
Pat_list(2).numScan = 6;
Pat_list(2).band_t = 270;
Pat_list(2).band_x = 1.6;
Pat_list(2).band_y = 1.6;
Pat_list(2).band_z = 1.6;
Pat_list(2).band_f = 1.0;
...
Pat_list(4).band_x = 2.0; % 1.0 1.1 .95 .8 1.2
Pat_list(4).band_y = 2.0;
Pat_list(4).band_z = 2.0;
Pat_list(4).band_f = 1.0;

Pat_list(5).name = 'P0';
Pat_list(5).ID = 'P10';
Pat_list(5).numScan = 4;
Pat_list(5).band_t = 360;
Pat_list(5).band_x = 1.8;
Pat_list(5).band_y = 1.8;
Pat_list(5).band_z = 1.8;
Pat_list(5).band_f = 1;
...
Pat_list(7).band_x = 1.8; % 1.1
Pat_list(7).band_y = 1.8; % 1.1
Pat_list(7).band_z = 1.8; % 1.1 0.65

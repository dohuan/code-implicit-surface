...
if (strcmp(dataType,'all')==1)
    ...
    % --- LAST 3 SCANS
    Pat_list(1).name = 'HH'; % good (kind of)
    Pat_list(1).ID = 'H';
    Pat_list(1).numScan = 4; %7
    Pat_list(1).band_t = 210; %
    Pat_list(1).band_x = 1.05; % 1.05
    Pat_list(1).band_y = 1.05; % 0.05
    Pat_list(1).band_z = 2.0; % 1.05
    Pat_list(1).band_f = 0.95; % 0.95
    % --- LAST 3 SCANS
    Pat_list(2).name = 'II'; % good (kind of)
    Pat_list(2).ID = 'I';
    ...
    Pat_list(2).band_y = 1.0;
    Pat_list(2).band_z = 1.0; 
    Pat_list(2).band_f = 0.9; % 1.0 0.9
    % --- LAST 3 SCANS
    Pat_list(3).name = 'JJ'; % good
    Pat_list(3).ID = 'J';
    ...
    Pat_list(3).band_f = 0.90;
    % --- LAST 3 SCANS
    Pat_list(4).name = 'KK'; % good
    Pat_list(4).ID = 'K';
    Pat_list(4).numScan = 4; % 5
    Pat_list(4).band_t = 350; %270
    Pat_list(4).band_x = 1.0; % 1.0 1.1 .95 .8 1.2
    Pat_list(4).band_y = 1.0; % 1.0
    Pat_list(4).band_z = 2.5; % 0.9 1.0
    Pat_list(4).band_f = 1.0; % 1.1 0.9
    % --- LAST 3 SCANS
    Pat_list(5).name = 'P0';
    Pat_list(5).ID = 'P10';
    Pat_list(5).numScan = 4;

...
V = reshape(A,5,5,5);
gridtmp_x = linspace(min(spatial_grild(:,1)),max(spatial_grild(:,1)),100);
gridtmp_y = linspace(min(spatial_grild(:,2)),max(spatial_grild(:,2)),100);
gridtmp_z = linspace(min(spatial_grild(:,3)),max(spatial_grild(:,3)),100);
